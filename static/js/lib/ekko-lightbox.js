...
(function () {
    ...
    EkkoLightbox = function (element, options) {
        ...
        header = this.options.title ? '<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">' + this.options.title + '</h4></div>' : '<button type="button" class="solo-close" data-dismiss="modal" aria-hidden="true">&times;</button>';
    ...
    EkkoLightbox.prototype = {
        ...
        checkImageDimensions: function (img) {
            var w;
            w = $(window);
            if ((img.width + (this.padding.left + this.padding.right)) > w.width()) {
                return img.width = w.width() - (this.padding.left + this.padding.right);
            }
        }
    };
