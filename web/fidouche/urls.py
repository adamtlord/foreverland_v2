...
urlpatterns = [
    ...
    url(
        r"^gigs/view/(?P<gig_id>\d+)/$", gig_finances_view, {}, name="gig_finances_view"
    ),
    ...
    url(
        r"^expenses/(?P<expense_id>\d+)/$", expense_details, {}, name="expense_details"
    ),
    url(r"^expenses/create/$", expense_create, {}, name="expense_create"),
    url(
        r"^expenses/delete/(?P<expense_id>\d+)/$",
        expense_delete,
        {},
        name="expense_delete",
    ),
    ...
    url(
        r"^vendor-payments/(?P<vendor_id>\d+)$",
        vendor_payments,
        {},
        name="vendor_payments",
    ),
    url(
        r"^production-payments/(?P<company_id>\d+)$",
        production_payments,
        {},
